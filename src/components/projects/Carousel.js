...
import NextImage from '@public/img/next.jpg'
...
const projects = [
  {
    ...
    projectUrl: 'https://tlachia.vercel.app',
  },
  {
    name: 'The Zen',
  ...
  {
    name: 'CRUD with stats',
    title: 'Just for practice',
    role: 'API fetching and crud',
    imageUrl: NextImage,
    projectUrl: 'https://nathan-crud-next-js.vercel.app/dashboard',
  },
]
