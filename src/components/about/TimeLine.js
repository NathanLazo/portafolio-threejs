...
import { SiThreedotjs, SiHiveBlockchain, SiSolidity, SiNextdotjs } from "react-icons/si";
...
import { FaLaptopCode, FaAngular, FaLaravel, FaReact, FaEthereum, FaUnity } from "react-icons/fa";
...
const TimeLine = ({selected}) => {
  return (
    <div className="flex justify-center w-full z-50 rounded-xl shadow-2xl px-6 py-8">
